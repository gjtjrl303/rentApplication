...
import entitiy.Customer;           // ★ import 위치 중요
...
public class LoginView extends JFrame {
    // 불필요: private final Customer loginUser; (필요 없음)
    ...
    public LoginView() {
        ...
        loginBtn.addActionListener(e -> {
            if (adminRadio.isSelected()) {
                ...
                Customer loginUser = dao.login(id, pw); // Customer 객체로 반환
                ...
                if (loginUser != null) {
                    ...
                    System.out.println("라이선스번호: " + loginUser.getLicenseNumber());
                    System.out.println("이메일: " + loginUser.getEmail());
                    dispose();
                    new UserView(loginUser); // 회원 정보 넘기기!
                } else {
